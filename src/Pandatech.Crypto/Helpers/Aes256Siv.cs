...
/// <summary>
///     AES-256-SIV (RFC 5297) deterministic authenticated encryption.
///     The same plaintext and key always produce the same ciphertext, which allows encrypted equality lookups.
/// </summary>
public static class Aes256Siv
{
    ...
    /// <summary>
    ///     Encrypt a UTF-8 string using the registered global key.
    /// </summary>
    ...
    /// <summary>
    ///     Encrypt a UTF-8 string using an optional override key.
    /// </summary>
    ...
    /// <summary>
    ///     Encrypt bytes using the registered global key.
    /// </summary>
    ...
    /// <summary>
    ///     Encrypt bytes using an optional override key.
    /// </summary>
    ...
    /// <summary>
    ///     Decrypt ciphertext to a UTF-8 string using the registered global key.
    /// </summary>
    ...
    /// <summary>
    ///     Decrypt ciphertext to a UTF-8 string using an optional override key.
    /// </summary>
    ...
    /// <summary>
    ///     Decrypt ciphertext to bytes using the registered global key.
    /// </summary>
    ...
    /// <summary>
    ///     Decrypt ciphertext to bytes using an optional override key. Returns an empty array for inputs shorter than
    ///     16 bytes.
    /// </summary>
        ...
        if (string.IsNullOrEmpty(overrideKey))
        {
            return GlobalKey is null
                ? throw new InvalidOperationException(
                    "AES256 Key not configured. Call RegisterKey(...) or provide a key.")
