...
public static class Password
{
    ...
    /// <summary>
    ///     Generate a cryptographically random password containing at least one character from each selected set.
    /// </summary>
    ...
    /// <summary>
    ///     Validate that a password meets the given length and character set requirements.
    /// </summary>
