#pragma warning disable CS0618 // Tests intentionally cover the obsolete class until it is removed
...
public class Aes256SivLegacyTests
{
    ...
    public void EncryptDecrypt_InlineData_WorksForAllKindOfStrings(string original)
    {
        ...
        // Act
        var encrypted = Aes256SivLegacy.Encrypt(original, key);
        var decrypted = Aes256SivLegacy.Decrypt(encrypted, key);
    ...
    public void Encrypt_TheSamePlaintextTwice_ProducesSameCiphertext()
    {
        ...
        // Act
        var cipher1 = Aes256SivLegacy.Encrypt(original, key);
        var cipher2 = Aes256SivLegacy.Encrypt(original, key);
    ...
    public void Encrypt_EmptyPlaintext_ReturnsEmptyCiphertext()
    {
        ...
        // Act
        var result = Aes256SivLegacy.Encrypt(emptyPlaintext, key);
    ...
    public void Decrypt_EmptyCiphertext_ReturnsEmptyPlaintext()
    {
        ...
        // Act
        var result = Aes256SivLegacy.DecryptToBytes(emptyCiphertext, key);
    ...
    public void Decrypt_CiphertextTooShort_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => Aes256SivLegacy.Decrypt(invalidCipher, key));
    }
    ...
    public void Decrypt_TamperedCiphertext_ThrowsCryptographicException()
    {
        ...
        // Act & Assert
        Assert.Throws<CryptographicException>(() => Aes256SivLegacy.Decrypt(encrypted, key));
    }
    ...
    public void EncryptDecrypt_InvalidOverrideKey_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => Aes256SivLegacy.Encrypt(original, invalidKey));
    }
    ...
    public void RegisterKey_ThenEncryptDecrypt_WorksCorrectly()
    {
        ...
        // Act
        var encrypted = Aes256SivLegacy.Encrypt(original);
        var decrypted = Aes256SivLegacy.Decrypt(encrypted);
    ...
    public void EncryptDecryptStream_RoundTrip_ReturnsOriginalData()
    {
        ...
        // Act
        Aes256SivLegacy.Encrypt(inputStream, encryptStream, key);

        // Reset position on the encrypted data
        encryptStream.Seek(0, SeekOrigin.Begin);

        Aes256SivLegacy.Decrypt(encryptStream, decryptStream, key);
    ...
    public void EncryptDecryptStream_EmptyContent_ProducesEmptyContent()
    {
        ...
        // Act
        Aes256SivLegacy.Encrypt(emptyInput, encryptStream, key);
        encryptStream.Seek(0, SeekOrigin.Begin);
    ...
    public void EncryptStream_InvalidKey_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => Aes256SivLegacy.Encrypt(data, output, invalidKey));
    }
    ...
    public void ExportImport_RawBinary_RoundTrip_Succeeds()
    {
        ...
        // --- import side ----------------------------------------------------
        var decrypted = Aes256SivLegacy.Decrypt(cipher, key); // byte[]
